        ...
        var newNode = function(resultId,type,resultColumns,x, y) {            
            ...
            if(resultColumns.length > 0 && typeof(resultColumns) !='undefined'){            
                for (var i = 0; i < resultColumns.length; i++) {
                    ...
                    colDiv.id=type+ '--' +resultId +'--'+resultColumns[i].name;                    
                    $(colDiv).attr('data-column-name',resultColumns[i].name);
                    $(colDiv).attr('data-column-function',false);
                    $(colDiv).attr('data-column-type',resultColumns[i].type)
                    $(colDiv).attr('data-toggle','popover');
                    $(colDiv).attr('data-content',resultColumns[i].name);
                    ...
                    $(colDiv).append('<span class="endPointDiv endPointLeft">&#8226;</span>'+resultColumns[i].name+'<span class="endPointDiv endPointRight">&#8226;</span>') ;
